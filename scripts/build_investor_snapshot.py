...
SOURCE_PATH = PROJECT_ROOT / "data" / "frontend" / "investor_metrics_source.json"

OUTPUT_PATH = PROJECT_ROOT / "data" / "frontend" / "investor_metrics.json"
...
def build_growth_display(
    *,
    ...
    return (
        growth,
        format_percentage_growth(growth),
    )
...
def build_snapshot() -> dict[str, Any]:
    ...
    output: dict[str, Any] = {
        ...
        "as_of_year": source["as_of_year"],
        "previous_year": source["previous_year"],
        "companies": {},
    }

    for ticker, company in source["companies"].items():
        ...
        for metric in company["metrics"]:
            ...
            if growth_percent is None:
                ...
                growth_display = f"{growth_percent:+.1f}%"
            ...
            processed_metrics.append(
                {
                    **metric,
                    ...
                    "previous_display_value": format_value(
                        previous,
                        unit,
                    ),
...
def main() -> None:
    ...
    print(("Investor growth comparison " f"written to {OUTPUT_PATH}"))
