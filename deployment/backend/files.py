...
GENERATED_REPORTS_DIR = PROJECT_ROOT / "outputs" / "generated_reports"
...
def get_generated_file_path(
    ...
    file_path = (GENERATED_REPORTS_DIR / safe_filename).resolve()

    generated_directory = GENERATED_REPORTS_DIR.resolve()

    if file_path.parent != generated_directory:
